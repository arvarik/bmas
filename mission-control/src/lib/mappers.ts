...
export function mapTaskMeta(task: Record<string, unknown>): TaskMeta {
  return {
    ...
    execution_snapshot: task.execution_snapshot as Record<string, unknown> | undefined,
    execution_snapshot_checksum: task.execution_snapshot_checksum as string | undefined,
    benchmark: task.benchmark as Record<string, string> | undefined,
