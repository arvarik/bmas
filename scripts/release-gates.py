...
RELEASE_GATES: dict[str, list[str]] = {
    ...
    "foundation_shared_conformance": ["daemon.cross-runtime-conformance", "daemon.behavioral-conformance", "daemon.behavioral-conformance-stack", "daemon.foundation-release-gate"],
