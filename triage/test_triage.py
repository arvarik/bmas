...
Usage:
  python3 test_triage.py                         # Default: 192.168.4.240:8001
...
from client import MODEL, GUIDED_CHOICE, SYSTEM_PROMPT, classify
from report import C, print_header, print_table_header, print_row, print_summary
from test_cases import TEST_CASES


def main() -> None:
    parser = argparse.ArgumentParser(description="bMAS Triage Router Evaluation Suite")
    parser.add_argument("--url", default="http://192.168.4.240:8001", help="vLLM base URL (no /v1)")
